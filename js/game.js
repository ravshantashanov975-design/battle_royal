 // JavaScript - Asosiy o'zgaruvchilar
        ...
        // Qurollar
        const WEAPONS = [
            { name: 'Pichoq', damage: 300, color: '#888888', fireRate: 500, range: 90, ammo: -1 },
            { name: 'Pistol', damage: 310, color: '#666666', fireRate: 400, range: 200, ammo: -1 },
            { name: 'Shotgun', damage: 500, color: '#8B4513', fireRate: 800, range: 180, ammo: -1 },
            { name: 'SMG', damage: 240, color: '#FFD700', fireRate: 150, range: 180, ammo: -1 },
            { name: 'AK-47', damage: 450, color: '#8B0000', fireRate: 200, range: 250, ammo: -1 },
            { name: 'M4A1', damage: 310, color: '#4169E1', fireRate: 180, range: 280, ammo: -1 },
            { name: 'Sniper', damage: 900, color: '#2F4F4F', fireRate: 1200, range: 400, ammo: -1 },
            { name: 'Minigun', damage: 300, color: '#FF4500', fireRate: 100, range: 200, ammo: -1 },
            { name: 'AWM', damage: 1200, color: '#000000', fireRate: 1500, range: 500, ammo: -1 },
        ...
        function draw() {
            ...
            if (gameMode === 1) {
                ...
                if (isMobile()) {
                    ...
                    // Yuqori ekran - Player 2 (teskari)
                    if (player2 && player2.alive) {
                        ctx.save();
                        ctx.translate(canvas.width / 2, halfHeight / 2);
                        ctx.rotate(Math.PI);
                        ctx.translate(-canvas.width / 2, -halfHeight / 2);
